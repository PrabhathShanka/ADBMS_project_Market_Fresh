...
$sql = "SELECT * FROM customer WHERE CusId = '$NIC'"; // Replace 'user_NI' with the specific user's NI
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $lastName = $row["CusName"];
        $address = $row["CusAddress"];
        $teleNumber = $row["CusTeleNo"];
        $email = $row["CusEmail"];
        $pass1 = $row["pass1"];
    }
} else {
...
if (!$con) {
 ...
 $sql = "UPDATE `customer` SET `CusName`='$first',`CusAddress`='$addre',`CusTeleNo`='$num',`CusEmail`='$em',`pass1`= '$password1' WHERE `CusId`='$NIC'";
...
<div class="container-fluid bg-secondary booking my-0 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="row gx-5">
         ...
         <div class="col-lg-6">   <!--dikkaranna-->
                <div class="bg-primary h-100 d-flex flex-column justify-content-center  p-5 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <h4> <?php echo "Your Costomer ID : $NIC"; ?></h4>
    ...
    <div class="row g-3">
        <div class="col-12 col-sm-6">
            <h5> Name:</h5>
            <input type="text" name="firstName" class="form-control border-0" placeholder="First Name" style="height: 55px;" value="<?php echo isset($lastName) ? $lastName : ''; ?>" required>
        </div>
        ...
        <div class="col-12 col-sm-6">
            ...
            <input type="text" name="number" class="form-control border-0" placeholder="Contact" style="height: 55px;" value="<?php echo isset($teleNumber) ? $teleNumber : ''; ?>" required>
        </div>
        <div>
            <h5>Email:</h5>
