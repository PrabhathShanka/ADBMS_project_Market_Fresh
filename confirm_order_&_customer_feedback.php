            ...
            <div class="container">
                ...
                <div class="col-lg-6">   <!--dikkaranna-->
                        <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                            <h1 class="text-white mb-4">Coustemer Feedback</h1>  
                              
                               <br>
                            <form action = "feedback_insert_nosql.php" method="POST" id ="form1">
                                
                                <div class="row g-3">

                                <div class="col-12 col-sm-6" required>
                                    <textarea id="Coustemer_Feedback" name="Coustemer_Feedback" rows="4" cols="50" required></textarea>
                                </div>


                                <input type="hidden" id="orderID" name="orderID" value="<?php echo isset($OrdeID) ? $OrdeID : ''; ?>" required>
